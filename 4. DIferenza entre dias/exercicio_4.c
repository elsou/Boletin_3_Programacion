...
int calcular_distancia (Date d1, Date d2){
    ...
    if(d1.year == d2.year){
        ...
        //En distintos anos, súmanse os días no último ano, os días que faltan para completar o primeiro ano, e os días dos anos intermedios
